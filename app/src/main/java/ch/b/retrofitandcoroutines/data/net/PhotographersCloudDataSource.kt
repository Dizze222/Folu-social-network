...
interface PhotographersCloudDataSource{
    ...
    suspend fun makePost(author: String,idPhotographer: Int,like: Int,theme: String,url: String) : Response<PhotographerCloud>
    class Base(private val service: PhotographerService) : PhotographersCloudDataSource{
        ...
        override suspend fun makePost(author: String,idPhotographer: Int,like: Int,theme: String,url: String)
        : Response<PhotographerCloud> = service.makePost(author, idPhotographer, like, theme, url)
